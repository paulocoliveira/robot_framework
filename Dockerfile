...
RUN echo 'APT::Get::Assume-Yes "true";' > /etc/apt/apt.conf.d/90devops \
  && echo 'DPkg::Options "--force-confnew";' >> /etc/apt/apt.conf.d/90devops

# Make sure PATH includes ~/.local/bin
# https://bugs.debian.org/cgi-bin/bugreport.cgi?bug=839155
# This only works for root. The devops user is done near the end of this Dockerfile
...
LABEL io.devops.preserve-entrypoint=true
